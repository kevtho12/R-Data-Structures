...
student_grade_level <- c('freshamn','senior')
...
my_array <- array(
  ...
  dim <- c(3,3,3),
  # row/column names
  dimnames<- list(c('row1','row2','row3'), c('col1','col2','lunch'),c('matrix1','matrix reloaded','matrix 3'))
)
my_array
```
...
my_factor<- factor(c('blue','green','brown','green','brown','gray'))
my_factor
```
...
```{r}
my_factor<- factor(
  c('blue','green','brown','green','brown','gray'),
